...
class GetVehicleEgoReq;
struct GetVehicleEgoReqDefaultTypeInternal;
extern GetVehicleEgoReqDefaultTypeInternal _GetVehicleEgoReq_default_instance_;
class GetVehicleEgoRes;
struct GetVehicleEgoResDefaultTypeInternal;
extern GetVehicleEgoResDefaultTypeInternal _GetVehicleEgoRes_default_instance_;
class Map;
...
template<> ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleEgoReq* Arena::CreateMaybeMessage<::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleEgoReq>(Arena*);
template<> ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleEgoRes* Arena::CreateMaybeMessage<::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleEgoRes>(Arena*);
...
class GetVehicleEgoReq final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq) */ {
 public:
  inline GetVehicleEgoReq() : GetVehicleEgoReq(nullptr) {}
  ~GetVehicleEgoReq() override;
  explicit PROTOBUF_CONSTEXPR GetVehicleEgoReq(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetVehicleEgoReq(const GetVehicleEgoReq& from);
  GetVehicleEgoReq(GetVehicleEgoReq&& from) noexcept
    : GetVehicleEgoReq() {
    *this = ::std::move(from);
  }

  inline GetVehicleEgoReq& operator=(const GetVehicleEgoReq& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetVehicleEgoReq& operator=(GetVehicleEgoReq&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetVehicleEgoReq& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetVehicleEgoReq* internal_default_instance() {
    return reinterpret_cast<const GetVehicleEgoReq*>(
               &_GetVehicleEgoReq_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    29;

  friend void swap(GetVehicleEgoReq& a, GetVehicleEgoReq& b) {
    a.Swap(&b);
  }
  inline void Swap(GetVehicleEgoReq* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetVehicleEgoReq* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetVehicleEgoReq* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetVehicleEgoReq>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetVehicleEgoReq& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetVehicleEgoReq& from) {
    GetVehicleEgoReq::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetVehicleEgoReq* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq";
  }
  protected:
  explicit GetVehicleEgoReq(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq)
 private:
  class _Internal;
...
class GetVehicleEgoRes final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes) */ {
 public:
  inline GetVehicleEgoRes() : GetVehicleEgoRes(nullptr) {}
  ~GetVehicleEgoRes() override;
  explicit PROTOBUF_CONSTEXPR GetVehicleEgoRes(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetVehicleEgoRes(const GetVehicleEgoRes& from);
  GetVehicleEgoRes(GetVehicleEgoRes&& from) noexcept
    : GetVehicleEgoRes() {
    *this = ::std::move(from);
  }

  inline GetVehicleEgoRes& operator=(const GetVehicleEgoRes& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetVehicleEgoRes& operator=(GetVehicleEgoRes&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetVehicleEgoRes& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetVehicleEgoRes* internal_default_instance() {
    return reinterpret_cast<const GetVehicleEgoRes*>(
               &_GetVehicleEgoRes_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    30;

  friend void swap(GetVehicleEgoRes& a, GetVehicleEgoRes& b) {
    a.Swap(&b);
  }
  inline void Swap(GetVehicleEgoRes* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetVehicleEgoRes* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetVehicleEgoRes* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetVehicleEgoRes>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetVehicleEgoRes& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetVehicleEgoRes& from) {
    GetVehicleEgoRes::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetVehicleEgoRes* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes";
  }
  protected:
  explicit GetVehicleEgoRes(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes)
 private:
  class _Internal;
...
// string simulation_id = 1 [(.google.api.field_behavior) = REQUIRED];
inline void GetVehicleEgoReq::clear_simulation_id() {
  _impl_.simulation_id_.ClearToEmpty();
}
inline const std::string& GetVehicleEgoReq::simulation_id() const {
  // @@protoc_insertion_point(field_get:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq.simulation_id)
  return _internal_simulation_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetVehicleEgoReq::set_simulation_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.simulation_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq.simulation_id)
}
inline std::string* GetVehicleEgoReq::mutable_simulation_id() {
  std::string* _s = _internal_mutable_simulation_id();
  // @@protoc_insertion_point(field_mutable:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq.simulation_id)
  return _s;
}
inline const std::string& GetVehicleEgoReq::_internal_simulation_id() const {
  return _impl_.simulation_id_.Get();
}
inline void GetVehicleEgoReq::_internal_set_simulation_id(const std::string& value) {
  
  _impl_.simulation_id_.Set(value, GetArenaForAllocation());
}
inline std::string* GetVehicleEgoReq::_internal_mutable_simulation_id() {
  
  return _impl_.simulation_id_.Mutable(GetArenaForAllocation());
}
inline std::string* GetVehicleEgoReq::release_simulation_id() {
  // @@protoc_insertion_point(field_release:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq.simulation_id)
  return _impl_.simulation_id_.Release();
}
inline void GetVehicleEgoReq::set_allocated_simulation_id(std::string* simulation_id) {
  if (simulation_id != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq.simulation_id)
}

// string vehicle_id = 2 [(.google.api.field_behavior) = REQUIRED];
inline void GetVehicleEgoReq::clear_vehicle_id() {
  _impl_.vehicle_id_.ClearToEmpty();
}
inline const std::string& GetVehicleEgoReq::vehicle_id() const {
  // @@protoc_insertion_point(field_get:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq.vehicle_id)
  return _internal_vehicle_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetVehicleEgoReq::set_vehicle_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.vehicle_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq.vehicle_id)
}
inline std::string* GetVehicleEgoReq::mutable_vehicle_id() {
  std::string* _s = _internal_mutable_vehicle_id();
  // @@protoc_insertion_point(field_mutable:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq.vehicle_id)
  return _s;
}
inline const std::string& GetVehicleEgoReq::_internal_vehicle_id() const {
  return _impl_.vehicle_id_.Get();
}
inline void GetVehicleEgoReq::_internal_set_vehicle_id(const std::string& value) {
  
  _impl_.vehicle_id_.Set(value, GetArenaForAllocation());
}
inline std::string* GetVehicleEgoReq::_internal_mutable_vehicle_id() {
  
  return _impl_.vehicle_id_.Mutable(GetArenaForAllocation());
}
inline std::string* GetVehicleEgoReq::release_vehicle_id() {
  // @@protoc_insertion_point(field_release:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq.vehicle_id)
  return _impl_.vehicle_id_.Release();
}
inline void GetVehicleEgoReq::set_allocated_vehicle_id(std::string* vehicle_id) {
  if (vehicle_id != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoReq.vehicle_id)
}
...
// .risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.ErrorMsg error = 1;
inline bool GetVehicleEgoRes::_internal_has_error() const {
  return this != internal_default_instance() && _impl_.error_ != nullptr;
}
inline bool GetVehicleEgoRes::has_error() const {
  return _internal_has_error();
}
inline void GetVehicleEgoRes::clear_error() {
  if (GetArenaForAllocation() == nullptr && _impl_.error_ != nullptr) {
    delete _impl_.error_;
  }
  _impl_.error_ = nullptr;
}
inline const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg& GetVehicleEgoRes::_internal_error() const {
  const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg* p = _impl_.error_;
  return p != nullptr ? *p : reinterpret_cast<const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg&>(
      ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::_ErrorMsg_default_instance_);
}
inline const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg& GetVehicleEgoRes::error() const {
  // @@protoc_insertion_point(field_get:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes.error)
  return _internal_error();
}
inline void GetVehicleEgoRes::unsafe_arena_set_allocated_error(
    ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg* error) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.error_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes.error)
}
inline ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg* GetVehicleEgoRes::release_error() {
...
inline ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg* GetVehicleEgoRes::unsafe_arena_release_error() {
  // @@protoc_insertion_point(field_release:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes.error)
  
  ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg* temp = _impl_.error_;
  _impl_.error_ = nullptr;
  return temp;
}
inline ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg* GetVehicleEgoRes::_internal_mutable_error() {
...
inline ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg* GetVehicleEgoRes::mutable_error() {
  ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg* _msg = _internal_mutable_error();
  // @@protoc_insertion_point(field_mutable:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes.error)
  return _msg;
}
inline void GetVehicleEgoRes::set_allocated_error(::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::ErrorMsg* error) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.error_;
  }
  ...
  _impl_.error_ = error;
  // @@protoc_insertion_point(field_set_allocated:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes.error)
}

// .risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.Vehicle vehicle = 2;
inline bool GetVehicleEgoRes::_internal_has_vehicle() const {
  return this != internal_default_instance() && _impl_.vehicle_ != nullptr;
}
inline bool GetVehicleEgoRes::has_vehicle() const {
  return _internal_has_vehicle();
}
inline void GetVehicleEgoRes::clear_vehicle() {
  if (GetArenaForAllocation() == nullptr && _impl_.vehicle_ != nullptr) {
    delete _impl_.vehicle_;
  }
  _impl_.vehicle_ = nullptr;
}
inline const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle& GetVehicleEgoRes::_internal_vehicle() const {
  const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle* p = _impl_.vehicle_;
  return p != nullptr ? *p : reinterpret_cast<const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle&>(
      ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::_Vehicle_default_instance_);
}
inline const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle& GetVehicleEgoRes::vehicle() const {
  // @@protoc_insertion_point(field_get:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes.vehicle)
  return _internal_vehicle();
}
inline void GetVehicleEgoRes::unsafe_arena_set_allocated_vehicle(
    ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle* vehicle) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.vehicle_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes.vehicle)
}
inline ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle* GetVehicleEgoRes::release_vehicle() {
...
inline ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle* GetVehicleEgoRes::unsafe_arena_release_vehicle() {
  // @@protoc_insertion_point(field_release:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes.vehicle)
  
  ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle* temp = _impl_.vehicle_;
  _impl_.vehicle_ = nullptr;
  return temp;
}
inline ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle* GetVehicleEgoRes::_internal_mutable_vehicle() {
...
inline ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle* GetVehicleEgoRes::mutable_vehicle() {
  ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle* _msg = _internal_mutable_vehicle();
  // @@protoc_insertion_point(field_mutable:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes.vehicle)
  return _msg;
}
inline void GetVehicleEgoRes::set_allocated_vehicle(::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::Vehicle* vehicle) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.vehicle_;
  }
  ...
  _impl_.vehicle_ = vehicle;
  // @@protoc_insertion_point(field_set_allocated:risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.GetVehicleEgoRes.vehicle)
}
