...
// string cookie = 4;
inline bool JwtLocation::_internal_has_cookie() const {
...
template <typename ArgT0, typename... ArgT>
inline void JwtLocation::set_cookie(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_cookie()) {
    clear_in();
    set_has_cookie();
    _impl_.in_.cookie_.InitDefault();
  }
  _impl_.in_.cookie_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void JwtLocation::_internal_set_cookie(const std::string& value) {
  ...
  _impl_.in_.cookie_.Set(value, GetArenaForAllocation());
}
inline std::string* JwtLocation::_internal_mutable_cookie() {
  ...
  return _impl_.in_.cookie_.Mutable(      GetArenaForAllocation());
}
...
inline void JwtLocation::set_allocated_cookie(std::string* cookie) {
  ...
  if (cookie != nullptr) {
    set_has_cookie();
    _impl_.in_.cookie_.InitAllocated(cookie, GetArenaForAllocation());
  }
