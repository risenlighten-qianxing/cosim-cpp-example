...
static const char* SimulationV2_method_names[] = {
  ...
  "/risenlighten.lasvsim.simulation_task_kratos.api.simulation.v2.SimulationV2/GetVehicle",
...
SimulationV2::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_GetVehicle_(SimulationV2_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status SimulationV2::Stub::GetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response) {
  return ::grpc::internal::BlockingUnaryCall< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetVehicle_, context, request, response);
}

void SimulationV2::Stub::async::GetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetVehicle_, context, request, response, std::move(f));
}

void SimulationV2::Stub::async::GetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>* SimulationV2::Stub::PrepareAsyncGetVehicleRaw(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetVehicle_, context, request);
}

::grpc::ClientAsyncResponseReader< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>* SimulationV2::Stub::AsyncGetVehicleRaw(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
SimulationV2::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SimulationV2::Service, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SimulationV2::Service* service,
             ::grpc::ServerContext* ctx,
             const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* req,
             ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* resp) {
...
::grpc::Status SimulationV2::Service::GetVehicle(::grpc::ServerContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
