 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    // 根据id获取自测车辆信息
    virtual ::grpc::Status GetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>> AsyncGetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>>(AsyncGetVehicleRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>> PrepareAsyncGetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>>(PrepareAsyncGetVehicleRaw(context, request, cq));
    }
    ...
    class async_interface {
     public:
      ...
      // 根据id获取自测车辆信息
      virtual void GetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // 获取仿真结果数据 map<string, [][]float64> 多层嵌套结构
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>* AsyncGetVehicleRaw(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>* PrepareAsyncGetVehicleRaw(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status GetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>> AsyncGetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>>(AsyncGetVehicleRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>> PrepareAsyncGetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>>(PrepareAsyncGetVehicleRaw(context, request, cq));
    }
    ...
    class async final :
     ...
     public:
      ...
      void GetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response, std::function<void(::grpc::Status)>) override;
      void GetVehicle(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response, ::grpc::ClientUnaryReactor* reactor) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>* AsyncGetVehicleRaw(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>* PrepareAsyncGetVehicleRaw(::grpc::ClientContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // 根据id获取自测车辆信息
    virtual ::grpc::Status GetVehicle(::grpc::ServerContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response);
    // 获取仿真结果数据 map<string, [][]float64> 多层嵌套结构
  ...
  class WithAsyncMethod_GetVehicle : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetVehicle(::grpc::ServerContext* /*context*/, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* /*request*/, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGetVehicle(::grpc::ServerContext* context, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* request, ::grpc::ServerAsyncResponseWriter< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_GetVehicle() {
      ::grpc::Service::MarkMethodCallback(7,
          new ::grpc::internal::CallbackUnaryHandler< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* request, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* response) { return this->GetVehicle(context, request, response); }));}
    void SetMessageAllocatorFor_GetVehicle(
        ::grpc::MessageAllocator< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(7);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* GetVehicle(
      ::grpc::CallbackServerContext* /*context*/, const ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq* /*request*/, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_GetVehicle() {
      ::grpc::Service::MarkMethodStreamed(7,
        new ::grpc::internal::StreamedUnaryHandler<
          ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq, ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedGetVehicle(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleReq,::risenlighten::lasvsim::simulation_task_kratos::api::simulation::v2::GetVehicleRes>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
